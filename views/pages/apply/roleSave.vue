      ...
      <el-row>
        <el-col>
          <el-form ref="form" :model="form" :rules="rules" label-width="100px">
            ...
            <el-form-item label="申请角色:" prop="wantId">
...
<script type="text/javascript">
  ...
  import {request_role,request_apply, result_code,request_user} from 'common/request_api'
  import {tools_verify} from 'common/tools'

  export default{
    data(){
      return {
        select_url: request_role.applyRole,
        form: {
          applyContent: null,
          privilegeId: null,
        },
    ...
    methods: {
      ...
      on_submit_form(){
        this.$refs.form.validate((valid) => {
          ...
          this.axios.post(request_apply.saveRole, param)
