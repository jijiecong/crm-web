      ...
      <el-row>
        <el-col>
          <el-form ref="form" :model="form" :rules="rules" label-width="100px">
            ...
            <el-form-item label="新部门:" prop="toGroupId">
              <simple-select :selectUrl="select_url" v-model="form.toGroupId"></simple-select>
            </el-form-item>
            <el-form-item>
...
<script type="text/javascript">
  ...
  import {request_group, result_code,request_user} from 'common/request_api'
  ...
  export default{
    data(){
      ...
      return {
        select_url: request_group.search,
        form: {
          userId: null,
          toGroupId: null,
          fromGroupId: null,
