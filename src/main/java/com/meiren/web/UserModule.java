...
/*            if(!this.hasUserAll(user)){
            ...
            result = aclUserService.updateAclUser(userId, updateMap);
...
/*            if(!this.hasUserAll(user)){
    ...
    @ResponseBody
    public ApiResult disable(HttpServletRequest request, HttpServletResponse response) {
        ApiResult result = new ApiResult();
...
//            this.forcedLogout(userEntity);
    ...
    @ResponseBody
    public ApiResult hierarchySet(HttpServletRequest request, HttpServletResponse response) {
        ApiResult result = new ApiResult();
        try {
            SessionUserVO user = this.getUser(request);
            /*if(!this.hasUserAll(user)){
            ...
            result = aclUserService.updateAclUser(userId, paramMap);
        } catch (Exception e) {
            result.setError(e.getMessage());
            return result;
        }
        ...
        try {
            ...
            switch (type) {
                case "init":
                    ...
                    break;
                case "right":
                    result = this.roleControlAdd(selectedIds_arr, userId);     //禁用
                    break;
                case "left":
                    result = this.roleControlDel(selectedIds_arr, userId);     //取消禁用
                    break;
                default:
     ...
     * @throws Exception
     */
    private ApiResult roleControlDel(String[] selectedIds_arr, Long uid) throws Exception {
        ApiResult result = new ApiResult();
        for(String id : selectedIds_arr){
            ...
            result = aclUserHasRoleService.deleteAclUserHasRole(ObjectUtils.entityToMap(entity));
        }
        return result;
    }
     ...
     * @return ApiResult
     */
    private ApiResult roleControlAdd(String[] selectedIds_arr, Long uid) {
        ApiResult result = new ApiResult();
        for(String id : selectedIds_arr){
            AclUserHasRoleEntity entity = new AclUserHasRoleEntity();
            entity.setStatus(UserRoleStatusEnum.DELETE.name());
            entity.setUserId(uid);
            entity.setRoleId(Long.parseLong(id));
            result = aclUserHasRoleService.createAclUserHasRole(entity);
        }
        return result;
    }
        ...
        try {
            ...
            switch (type) {
                case "init":
                    ...
                    break;
                case "right":
                    result = this.privilegeControlAdd(selectedIds_arr, userId);     //禁用
                    break;
                case "left":
                    result = this.privilegeControlDel(selectedIds_arr, userId);     //取消禁用
                    break;
                default:
                    throw new Exception("type not find");
            }
     ...
     * @throws Exception
     */
    private ApiResult privilegeControlDel(String[] selectedIds_arr, Long uid) throws Exception {
        ApiResult result = new ApiResult();
        for(String id : selectedIds_arr) {
            ...
            result = aclUserHasPrivilegeService.deleteAclUserHasPrivilege(ObjectUtils.entityToMap(entity));
        }
        return result;
    }
     ...
     * @return
     */
    private ApiResult privilegeControlAdd(String[] selectedIds_arr, Long uid) {
        ApiResult result = new ApiResult();
        for(String id : selectedIds_arr) {
            AclUserHasPrivilegeEntity entity = new AclUserHasPrivilegeEntity();
            entity.setStatus(UserPrivilegeStatusEnum.DELETE.name());
            entity.setUserId(uid);
            entity.setPrivilegeId(Long.parseLong(id));
            result = aclUserHasPrivilegeService.createAclUserHasPrivilege(entity);
        }
        return result;
    }
