define("arale/widget/1.0.3/daparser-debug", [ "$-debug" ], function(require, DAParser) {
    // DAParser
    // --------
...
define("arale/widget/1.0.3/auto-render-debug", [ "$-debug" ], function(require, exports) {
    var $ = require("$-debug");
...
define("arale/widget/1.0.3/widget-debug", [ "./daparser-debug", "./auto-render-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "$-debug" ], function(require, exports, module) {
    // Widget
    // ---------
    ...
    var Widget = Base.extend({
        ...
        initialize: function(config) { console.log(this);
            this.cid = uniqueCid();
            // 初始化 attrs
