...
define(function(require, exports, module) {
    ...
    function MissionBasic(){
        ...
        this.route = {
            add: "/mission/filter/add",
            modify: "/mission/filter/modify",
            edit: "/mission/filter/edit",
            delMission: "/mission/filter/delete",
            detail:"/mission/filter/detail"
        };
    ...
    return {
        ...
        init: function() {
            ...
            $(".setForm").on("click", function(){
                ...
                showIframe('/mission/filter/build',1300,800);
            });
